...
$query_item = "SELECT * FROM content WHERE active='1' AND type='guides' LIMIT 10";
...
<div class="banner-wrap movie-reviews">
    ...
    <div class="banner grid-limit">
        <h1 class="banner-title">Game Guides</h1>
        <p class="banner-sections">
            ...
            <!-- /ARROW ICON -->
            <span class="banner-section">Guides</span>
        </p>
    </div>
    <!-- /BANNER -->
</div>
