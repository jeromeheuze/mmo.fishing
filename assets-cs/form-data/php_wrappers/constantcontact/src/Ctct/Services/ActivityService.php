...
class ActivityService extends BaseService
{
    ...
    {
        $baseUrl = ActivityService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.activities');
    ...
    {
        $baseUrl = ActivityService . phpConfig::get('endpoints.base_url') . sprintf(Config::get('endpoints.activity'), $activityId);
    ...
    {
        $baseUrl = ActivityService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.add_contacts_activity');
        $url = $this->buildUrl($baseUrl);
    ...
    {
        $baseUrl = ActivityService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.clear_lists_activity');
        $url = $this->buildUrl($baseUrl);
    ...
    {
        $baseUrl = ActivityService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.export_contacts_activity');
        $url = $this->buildUrl($baseUrl);
    ...
    {
        $baseUrl = ActivityService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.remove_from_lists_activity');
        $url = $this->buildUrl($baseUrl);
        $payload = array(
            'import_data' => array(),
            'lists' => $lists
