...
class AccountService extends BaseService
{
    ...
    {
        $baseUrl = AccountService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.account_verified_addresses');
    ...
    {
        $baseUrl = AccountService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.account_info');
