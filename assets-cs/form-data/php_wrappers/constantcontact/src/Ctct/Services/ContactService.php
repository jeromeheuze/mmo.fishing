...
class ContactService extends BaseService
{
    ...
    {
        $baseUrl = ContactService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.contacts');
    ...
    {
        $baseUrl = ContactService . phpConfig::get('endpoints.base_url') . sprintf(Config::get('endpoints.contact'), $contactId);
    ...
    {
        $baseUrl = ContactService . phpConfig::get('endpoints.base_url') . sprintf(Config::get('endpoints.contact_lists'), $contactId);
        $url = $this->buildUrl($baseUrl);
        $response = parent::getRestClient()->delete($url, parent::getHeaders($accessToken));
        return ($response->info['http_code'] == 204) ? true : false;
    }
    ...
    {
        $baseUrl = ContactService . phpConfig::get('endpoints.base_url') .
    ...
    {
        $baseUrl = ContactService . phpConfig::get('endpoints.base_url') . sprintf(Config::get('endpoints.contact'), $contact->id);
        $url = $this->buildUrl($baseUrl, $params);
