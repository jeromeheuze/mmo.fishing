...
class ListService extends BaseService
{
    ...
    {
        $baseUrl = ListService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.lists');
    ...
    {
        $baseUrl = ListService . phpConfig::get('endpoints.base_url') . sprintf(Config::get('endpoints.list'), $list->id);
        $url = $this->buildUrl($baseUrl);
    ...
    {
        $baseUrl = ListService . phpConfig::get('endpoints.base_url') . sprintf(Config::get('endpoints.list'), $list_id);
        $url = $this->buildUrl($baseUrl);
    ...
    {
        $baseUrl = ListService . phpConfig::get('endpoints.base_url') . sprintf(Config::get('endpoints.list_contacts'), $list_id);
        $url = $this->buildUrl($baseUrl, $params);
