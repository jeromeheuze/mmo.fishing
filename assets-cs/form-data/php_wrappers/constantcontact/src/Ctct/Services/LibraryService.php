...
class LibraryService extends BaseService
{
    ...
    {
        $baseUrl = LibraryService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.library_files');
    ...
    {
        $baseUrl = LibraryService . phpConfig::get('endpoints.base_url')
    ...
    {
        $baseUrl = LibraryService . phpConfig::get('endpoints.base_url') . Config::get('endpoints.library_folders');
        $url = $this->buildUrl($baseUrl, $params);
        $response = parent::getRestClient()->get($url, parent::getHeaders($accessToken));
        $body = json_decode($response->body, true);
