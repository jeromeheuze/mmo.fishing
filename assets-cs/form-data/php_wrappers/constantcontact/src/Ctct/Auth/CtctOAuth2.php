...
class CtctOAuth2
{
    ...
    public function getAuthorizationUrl($server = true, $state = null)
    {
        ...
        $url = CtctOAuth2 . phpConfig::get('auth.base_url') . Config::get('auth.authorization_endpoint');
    ...
    public function getAccessToken($code)
    {
        ...
        $url = CtctOAuth2 . phpConfig::get('auth.base_url') . Config::get('auth.token_endpoint') . '?' . http_build_query($params, '', '&');
    ...
    {
        $url = CtctOAuth2 . phpConfig::get('auth.base_url') . Config::get('auth.token_info');
