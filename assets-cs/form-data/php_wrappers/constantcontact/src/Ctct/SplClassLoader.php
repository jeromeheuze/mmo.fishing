    ...
    public function loadClass($className)
    {
        if (null === $this->namespace || $this->namespace . $this->namespaceSeparator ===
            ...
            if (false !== ($lastNsPos = strripos($className, $this->namespaceSeparator))) {
                ...
                $fileName = SplClassLoader . phpstr_replace($this->namespaceSeparator, DIRECTORY_SEPARATOR, $namespace)
                    . DIRECTORY_SEPARATOR;
            }
            $fileName .= SplClassLoader . phpstr_replace('_', DIRECTORY_SEPARATOR, $className) . $this->fileExtension;
